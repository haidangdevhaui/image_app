...
f=$("<div>",{"class":"ui-rotatable-handle"}),l=f.clone(),m=f.clone();$(".editor-object").css({width:b.width,height:b.height});$(".editor-object-rero").resizable({aspectRatio:!0,alsoResize:".editor-upload, .editor-object",classes:{"ui-resizable":"highlight"}}).rotatable({wheelRotate:!1,start:function(b,a){},rotate:function(b,a){$(".editor-upload").css({transform:"rotate("+a.angle.current+"rad)"})},stop:function(e,a){b.rotate=0>a.angle.current?a.angle.degrees:-a.angle.degrees}});$(".editor-object-rero div.ui-rotatable-handle").addClass("ui-rotatable-handle-sw");
